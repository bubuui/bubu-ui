      ...
      const s = e.ref(),
        ...
        c = e.computed(
          () => (
            ...
            t.rules[r.prop] && t.rules[r.prop].some((o) => o.required)
          )
        ),
        m = e.computed(() => [
          h,
        ...
        p = () => {
          ...
          const o = t.rules[r.prop],
            n = t.model[r.prop];
          return new f({ [r.prop]: o }).validate({ [r.prop]: n }, (u) => {
            u ? (l.value = u[0].message || '校验错误') : (l.value = '');
          });
        },
