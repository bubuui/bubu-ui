...
import { notificationEmits as p, notificationProps as v } from "./notification.mjs";
import { useTimeoutFn as h } from "../../../../../node_modules/.pnpm/@vueuse_shared@10.11.1_vue@3.5.12_typescript@5.6.3_/node_modules/@vueuse/shared/index.mjs";
const T = m({
  name: "BuNofication",
  emits: p,
  props: v,
