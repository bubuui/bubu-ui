  ...
  (function () {
    ...
    var runInContext = function runInContext2(context) {
      ...
      function baseClone(value, bitmask, customizer, key, object, stack2) {
        ...
        if (customizer) {
          result2 = object
            ? customizer(value, key, object, stack2)
            : customizer(value);
        }
        ...
        if (isSet2(value)) {
          value.forEach(function (subValue) {
            result2.add(
              baseClone(subValue, bitmask, customizer, subValue, value, stack2)
            );
          });
          ...
          value.forEach(function (subValue, key2) {
            result2.set(
              key2,
              baseClone(subValue, bitmask, customizer, key2, value, stack2)
            );
          });
        }
        var keysFunc = isFull
      ...
      function baseIntersection(arrays, iteratee2, comparator2) {
        var includes2 = comparator2 ? arrayIncludesWith : arrayIncludes,
        ...
        outer: while (++index < length && result2.length < maxLength) {
          ...
          if (
            !(seen
              ...
              : includes2(result2, computed2, comparator2))
          ) {
            othIndex = othLength;
            while (--othIndex) {
              ...
              if (
                !(cache
                  ...
                  : includes2(arrays[othIndex], computed2, comparator2))
              ) {
                continue outer;
              }
            }
      ...
      function baseIsEqualDeep(
        ...
        if (isSameTag && !objIsObj) {
          ...
          return objIsArr || isTypedArray(object)
            ? equalArrays(object, other, bitmask, customizer, equalFunc, stack2)
            : equalByTag(
                object,
                other,
                objTag,
      ...
      function baseMergeDeep(
        ...
        var newValue = customizer
          ? customizer(objValue, srcValue, key + '', object, source, stack2)
          : undefined$1;
      ...
      function basePullAll(array, values2, iteratee2, comparator2) {
        var indexOf2 = comparator2 ? baseIndexOfWith : baseIndexOf,
          index = -1,
        ...
        while (++index < length) {
          var fromIndex = 0,
            ...
            computed2 = iteratee2 ? iteratee2(value) : value;
          while (
            (fromIndex = indexOf2(seen, computed2, fromIndex, comparator2)) > -1
          ) {
            if (seen !== array) {
        ...
        while (++index < arrLength) {
          ...
          if (customizer) {
            var compared = isPartial
              ? customizer(othValue, arrValue, index, other, array, stack2)
              : customizer(arrValue, othValue, index, array, other, stack2);
          }
          ...
          if (seen) {
            if (
              !arraySome(other, function (othValue2, othIndex) {
                if (
                  ...
                  (arrValue === othValue2 ||
                    equalFunc(arrValue, othValue2, bitmask, customizer, stack2))
                ) {
            ...
            !(
              arrValue === othValue ||
              equalFunc(arrValue, othValue, bitmask, customizer, stack2)
            )
          ) {
            result2 = false;
            break;
      ...
      function equalObjects(
        ...
        while (++index < objLength) {
          ...
          if (customizer) {
            var compared = isPartial
              ? customizer(othValue, objValue, key, other, object, stack2)
              : customizer(objValue, othValue, key, object, other, stack2);
          }
          if (
            !(compared === undefined$1
              ? objValue === othValue ||
                equalFunc(objValue, othValue, bitmask, customizer, stack2)
              : compared)
          ) {
            result2 = false;
            break;
      ...
      var intersectionWith = baseRest(function (arrays) {
        var comparator2 = last(arrays),
          mapped = arrayMap(arrays, castArrayLikeObject);
        comparator2 =
          typeof comparator2 == 'function' ? comparator2 : undefined$1;
        if (comparator2) {
          mapped.pop();
        }
        return mapped.length && mapped[0] === arrays[0]
          ? baseIntersection(mapped, undefined$1, comparator2)
          : [];
      });
      ...
      function pullAllWith(array, values2, comparator2) {
        return array && array.length && values2 && values2.length
          ? basePullAll(array, values2, undefined$1, comparator2)
          : array;
      }
      ...
      function uniqWith(array, comparator2) {
        comparator2 =
          typeof comparator2 == 'function' ? comparator2 : undefined$1;
        return array && array.length
          ? baseUniq(array, undefined$1, comparator2)
          : [];
      }
      ...
      function isElement(value) {
        return (
          isObjectLike(value) && value.nodeType === 1 && !isPlainObject2(value)
        );
      }
...
const useFormItem = () => {
  const form = inject('buForm', void 0);
  const formItem = inject('buFormItem', void 0);
  return {
    form,
    formItem
  };
